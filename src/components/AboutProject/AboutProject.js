      ...
      <div className="aboutProject__container">
        ...
        <div className="aboutProject__timeline">
          <div className="aboutProject__timeline-part aboutProject__timeline-part_color_black">
            <p className="aboutProject__timeline-text aboutProject__timeline-text_color_white">
              1 неделя
            </p>
          </div>
          <div className="aboutProject__timeline-part aboutProject__timeline-part_color_gray">
            <p className="aboutProject__timeline-text aboutProject__timeline-text_color_black">
              4 недели
            </p>
          </div>
        </div>
        <div className="aboutProject__timeline-description">
          <p className="aboutProject__description aboutProject__description_back">
            Back-end
          </p>
          <p className="aboutProject__description aboutProject__description_front">
            Front-end
          </p>
        </div>
      </div>
